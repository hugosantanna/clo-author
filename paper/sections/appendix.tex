...
Un resultado con $|\delta^*| > 1$ es robusto: los no-observables tendrían que ser más influyentes que los observables para anular el efecto.
Un $\delta^* < 0$ indica que la selección no-observable tendría que operar en dirección contraria a la selección observable ---condición aún más favorable para la identificación.
